...
// sin pedirle al usuario que elija la granularidad. Solo devuelve puntos para
// los días/semanas/meses que tuvieron ingreso (sin relleno en cero) — el
// usuario pidió explícitamente revertir el relleno en cero, prefiere ver
// únicamente los periodos con datos reales.
